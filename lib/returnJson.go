...
func RetrunMessage(code string, message string, data interface{}) ReturnMsg {
	var res ReturnMsg
...
func ReturnCodeMsg(code string) string {
	switch code {
	case "1":
		return "ok"
	case "-1":
	...
	case "40012":
		return "不合法的缩略图文件大小"
	case "40013":
		return "设置错误，请联系管理员" //"不合法的 AppID ，请开发者检查 AppID 的正确性，避免异常字符，注意大小写"
	case "40014":
	...
	case "40051":
		return "分组名字不合法"
	case "40060":
		return "删除单篇图文时，指定的 article_indx 不合法"
	case "40079":
		return "无效的时间设置"
	case "40117":
		return "分组名字不合法"
	...
	case "40053":
		return "不合法的actioninfo，请开发者确认参数正确。"
	case "40071":
		return "不合法的卡券类型。"
	case "40072":
		return "不合法的编码方式。"
	...
	case "40122":
		return "不合法的库存数量。"
	case "40124":
		return "会员卡设置查过限制的 custom_field字段。"
	case "40127":
		return "卡券被用户删除或转赠中。"
	case "41012":
		return "缺少cardid参数。"
	...
	case "45031":
		return "库存为0。"
	case "45033":
		return "用户领取次数超过限制get_limit"
	case "41011":
		return "缺少必填字段。"
	case "45021":
		return "字段超过长度限制，请参考相应接口的字段说明。"
	case "40056":
		return "不合法的Code码。"
	case "43009":
		return "自定义SN权限，请前往公众平台申请。"
	case "43010":
		return "无储值权限，请前往公众平台申请。"
	case "444001":
		return "卡卷创建成功，二维码获取失败。"
	case "444002":
		return "数据操作失败。"
	case "444022":
		return "数据获取失败。"
	...
	case "440450":
		return "密码不一致。"
	case "444048":
		return "标签功能目前支持公众号为用户打上最多20个标签。"
	case "444049":
		return "标签功能目前支持公众号最多创建100个标签。"
	case "444444":
		return "该数据无法删除！"
	case "444":
		return "预览失败！"
